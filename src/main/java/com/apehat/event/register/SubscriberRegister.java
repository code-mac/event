...
public interface SubscriberRegister {
     ...
     * <p>
     * If the scope of subscriber is {@link SubscribeScope#GLOBAL} the register
     * will be find by all register.
     *
     * @param subscriber
     *         the subscriber to register
     * @throws NullPointerException
     *         the specified subscriber is null
     * @see SubscribeScope
     */
